...
#define IPAD_2_CPUTYPE                  @"Apple A5"
#define IPAD_3_CPUTYPE                  @"Apple A5X"
#define IPAD_4_CPUTYPE                  @"Apple A6X"
#define IPAD_AIR_CPUTYPE                @"Apple A7"

#define IOS_CPUTYPE_UNKNOWN             @"Apple CPU(before 4S/Ipad 2)"
