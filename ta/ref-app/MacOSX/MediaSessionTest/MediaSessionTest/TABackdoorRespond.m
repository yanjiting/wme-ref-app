...
- (NSDictionary *) JSONResponseForMethod:(NSString *) method URI:(NSString *) path data:(NSDictionary *) data
{
    ...
    if ([[[NSApplication sharedApplication] delegate] respondsToSelector:sel]) {
        id arg = [data objectForKey:@"arg"];
        id res = [[[NSApplication sharedApplication] delegate]
        ...
        NSString *details = [NSString stringWithFormat:@"you must define the selector '%@' in your NSApplicationDelegate.",
                             selStr];
