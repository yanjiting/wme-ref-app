...
static BYTE*  byRSExp[] = {NULL,      NULL,      NULL,      NULL,      NULL,      NULL,      NULL,      byRSExp7,  NULL,      NULL,
...
{
	if (m_nSymbleSize >= 0 && strcmp(m_strPreSouce.c_str(), lpsSource) == 0)
		return true;

	m_strPreSouce = lpsSource;
...
void CQR_Encode::GetRSCodeWord(BYTE* lpbyRSWork, int ncDataCodeWord, int ncRSCodeWord)
{
	int i, j;
