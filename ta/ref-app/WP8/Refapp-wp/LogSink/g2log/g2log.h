...
const int DEBUG = 1, INFO = 2, WARNING = 3, ERR=4, FATAL = 5;
...
#define G2_LOG_DEBUG  g2::internal::LogMessage("",0,"","DEBUG")
#define G2_LOG_INFO  g2::internal::LogMessage("",0,"","INFO")
#define G2_LOG_WARNING  g2::internal::LogMessage("",0,"","WARNING")
#define G2_LOG_ERR  g2::internal::LogMessage("",0,"","ERROR")
#define G2_LOG_FATAL  g2::internal::LogContractMessage("",0,"",k_fatal_log_expression)
