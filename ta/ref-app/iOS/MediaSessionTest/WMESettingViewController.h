...
typedef enum
{
    ...
    STATISTICS_VIDEO_CONNECTION,
    STATISTICS_AUDIO_CONNECTION,
    STATISTICS_NETWORK_INDEX,
    STATISTICS_SYSTEM_INFO
}STATISTICS_TYPE;
...
@property (nonatomic)  BOOL bLoopback;
...
@property (nonatomic) IBOutlet UISwitch *portraitRotationEnableSWT;
