...
int  upsamplingDyadic           ( unsigned char*    pucBufferYUV[3],   int iStrideY,int iStrideUV,
  ...
  void  upsamplingLanczos           ( unsigned char*          pucBufferY,    int   iStrideY,
                                      ...
                                      unsigned char*          pucBufferV,    int   iStrideV,
                                      ResizeParameters*       pcParameters );
  void  upsampling6tapBilin         ( unsigned char*    pucBufferY,unsigned char*    pucBufferU,unsigned char*    pucBufferV,   int iStrideY,int iStrideUV,
  ...
  void  xBasicDownsampling          ( int  iBaseW,   int  iBaseH,   int  iCurrW,   int  iCurrH,
    ...
    int
    upsamplingDyadic( unsigned char*    pucBufferY,unsigned char*    pucBufferU,unsigned char*    pucBufferV,   int iStrideY,int iStrideUV,
                                  unsigned char*    pucDstBufferY, unsigned char*    pucDstBufferU, unsigned char*    pucDstBufferV,   int iDstStrideY,int iDstStrideUV,
                     ResizeParameters* pcParameters );
#else
  //======================================
